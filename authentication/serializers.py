...
class GroupSerializer(serializers.ModelSerializer):
    ...
    def get_invited_users(self, obj):
        return list(set(user.email for user in obj.invited_users.all()))  # Get unique emails of invited users

    def get_contributors(self, obj):
        return list(set(user.email for user in obj.contributors.all()))  # Get unique emails of contributors
    ...
    class Meta:
        model = Group
        fields = ['id', 'property_id', 'created_by', 'goal_amount', 'minimum_contribution', 'total_raised', 'status', 'group_type', 'invited_users', 'contributors', 'deadline', 'created_at']
...
class ContributionSerializer(serializers.ModelSerializer):
    ...
    def get_group_id(self, obj):
        return obj.group.id  # Return group ID (you could customize this to return other group info)
